...
└── games/
    ...
    └── redeye-1-the-terminal.html      # Series 2 · Chapter I (in production)
```
...
### Series Two — The Red-Eye *(in production)*
...
| **II** | **The Red-Eye** | dual-track jet cabin (trails meet at the telex) | Work the cabin and the purser's station; decode the telex using the letters' numbers as a one-time key — the film is evidence of corruption, not romance. Then send one back. |
| **III** | **Arrivals** | multi-zone finale (immigration → customs → tarmac) | Use a wall of world clocks and time-zone math for the last code; get Roscoe and the proof through customs before the doors close. |
